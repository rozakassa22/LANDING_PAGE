...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className="bg -[#000000] max-w-screen-xl mt-16 px-8 xl:px-16 mx-auto" id="about">
      ...
      <ScrollAnimationWrapper className="">
        ...
        >
          <div className="flex flex-col justify-center items-start row-start-2 sm:row-start-1">
            <h1 className="text-3xl lg:text-4xl mt-20 xl:text-5xl font-medium text-white leading-normal">
             No more jumbling in sheets. 🎉 focus on your code,
              we will keep track of everything. 
                          </h1>
            <p className="text-white mt-6 mb-6">
            Empower Collaboration and Efficiency: Experience Seamless Educational Endeavors with the  Cinema <span className="text-[#7983FB]">Booking</span>, Your Centralized Solution for Streamlining Organization, Collaboration, and Knowledge Sharing.
            </p>
            <ButtonPrimary addClass="mt-4 text-white">Get Started</ButtonPrimary>
          </div>
