...
import Testimoni from "@/components/Testmoni"
import ButtonPrimary from "@/components/misc/ButtonPrimary";
import LogoVPN from "../../public/assets/Icon/checklist.svg";
import ButtonOutline from "@/components/misc/BottonOutline"
...
const Pricing = () => {
  ...
  return (
    <div
    className="bg-gradient-to-b from-white-300 to-[#000000] w-full py-14"
    id="pricing"
  >
        ...
        <ScrollAnimationWrapper className="relative w-full mt-16">
          <motion.div variants={scrollAnimation} custom={{duration: 3}}>
            <div className="absolute rounded-xl py-8 sm:py-14 px-6 sm:px-12 lg:px-16 w-full flex flex-col sm:flex-row justify-between items-center z-10 bg-white-500">
              <div className="flex text-white flex-col text-left w-10/12 sm:w-7/12 lg:w-5/12 mb-6 sm:mb-0">
